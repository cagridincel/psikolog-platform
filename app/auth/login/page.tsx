...
function LoginForm() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="bg-white rounded-2xl border p-10 w-full max-w-sm text-center">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Hosgeldiniz</h1>
        ...
        <p className="text-xs text-gray-400 mt-6">
          Giris yaparak kullanim kosullarini kabul etmis olursunuz.
        </p>
      </div>
    </main>
  )
